<?php
session_start();
if (!isset($_SESSION['idUsuario']) || $_SESSION['idRol'] != 4) {
...
<body>
    ...
    <div class="container">
        <div class="admin-info">
            ...
            <p>Soy Kristhian, estoy estudiando un tecnólogo de análisis y desarrollo de software y soy proveedor de la empresa.</p>
