...
<body>
    <header>
        <nav>
            <ul>
                ...
                <li><a href="cotizacion_creator.php">Crear cotizacion</a></li>
    ...
    <div class="container">
        <div class="admin-info">
            ...
            <p>Soy Felipe, estoy estudiando un tecnólogo de análisis y desarrollo de software y soy un ingeniero de la empresa.</p>
